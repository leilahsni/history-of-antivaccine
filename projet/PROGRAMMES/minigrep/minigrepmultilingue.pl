...
# B. le fichier contenant la forme ‡ extraire
...
while (my $ligne=<FILEIN>)  {
	...
	unless ($test == 1) {
	    print FILEOUT "<br/>"; #imprimer un retour ‡ la ligne si ligne du haut non affichÈe
	}
